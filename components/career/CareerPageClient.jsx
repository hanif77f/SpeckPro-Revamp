...
// All the interactive parts of the Career page live here — filters,
// the application modal, and the real backend submission. Split out of
// app/career/page.jsx so that file can go back to being a plain Server
// Component with real `metadata` (title/description/canonical), which a
// Client Component like this one can never export. Same pattern already
